	  ...
	  <div class="row mb-3">
    	...
    	<div class="col-sm-8 form-check-inline">
    		<label class="form-check-label" for="inlineCheckbox1">오렌지</label>
      		<input type="checkbox" class="form-check-input" name="FruitGroup" value="오렌지">
      		<label class="form-check-label" for="inlineCheckbox1">&nbsp;&nbsp;사과</label>
      		<input type="checkbox" class="form-check-input" name="FruitGroup" value="사과">
    		<label class="form-check-label" for="inlineCheckbox1">&nbsp;&nbsp;바나나</label>
      		<input type="checkbox" class="form-check-input" name="FruitGroup" value="바나나">
    	</div>
     </div>	
  	  <div class="row mb-3">
